...
{
    public class TempNetRouter<TNetHeader> where TNetHeader : INetDataHeader, new()
    {
        ...
        {
            if (!_callbacks.TryGetValue(netCommand, out var action)) throw new ParseException($"Network Error: Not implemented {netCommand} yet!");
        ...
        ///     <typeparamref name="TNetHeader" />'s fields are not supported, or it has no
        ///     fields
        /// </exception>
